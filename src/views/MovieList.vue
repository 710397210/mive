<template>
    <div>
        ...
        <hr/>
        <el-row v-for="subList in moiveList" type="flex" justify="center"
                style="margin-top: 20px">
            <el-col :span="4">
                <img v-bind:src="subList[0].imgUrl"/>
                <div>
                    <span class="title-span" v-on:click="detaiPage(subList[0].title)">{{subList[0].title}}</span>
                    &nbsp;&nbsp;
            ...
            <el-col :span="4">
                ...
                <div>
                    <span class="title-span" v-on:click="detaiPage(subList[1].title)">{{subList[1].title}}</span>
                    &nbsp;&nbsp;
            ...
            <el-col :span="4">
                ...
                <div>
                    <span class="title-span" v-on:click="detaiPage(subList[2].title)">{{subList[2].title}}</span>
                    &nbsp;&nbsp;
            ...
            <el-col :span="4">
                ...
                <div>
                    <span class="title-span" v-on:click="detaiPage(subList[3].title)">{{subList[3].title}}</span>
                    &nbsp;&nbsp;
            ...
            <el-col :span="4">
                ...
                <div>
                    <span class="title-span" v-on:click="detaiPage(subList[4].title)">{{subList[4].title}}</span>
                    &nbsp;&nbsp;
...
<script>
    ...
    export default {
        ...
        methods:{
            detaiPage:function (title) {
                //获取router对象，调用router对象的push方法
